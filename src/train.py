...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        ...
        'nerf':    dict(ref_gpus=gpus, kimg=25000,  mb=4, mbstd=4,  fmaps=1,   lrate=0.0025, r1_gamma=0.001,    ema=20,  ramp=0.05, map=2, width=128, num_layers=4, perturb=0.0, raw_noise_std=0.0, n_samples=16, n_importance=0, white_bkgd=False, patch_size=None),
    ...
    # resume = "data/checkpoint.pkl"
    # print(f"Trained on {resume}")
